...
class Mahasiswa
{
    ...
    {
        $query = "UPDATE $this->table SET `nim` = '$this->nim', `nama` = '$this->nama', `jk` = '$this->jk', `prodi` = '$this->prodi' WHERE id = $id";
        $this->db->query($query);
    ...
    {
        $query = "UPDATE $this->table SET `nama` = '$this->nama', `jk` = '$this->jk', `prodi` = '$this->prodi' WHERE nim = $nim";
        $this->db->query($query);
        return $this->db->affected_rows();
    }
